  ...
  const conversation = [
    {
      ...
      content:"Act as a data extractor, extract the data from various countries Resident ID using AWS textract api. The following data points needs to be extracted and arrange in a key value pair in JSON format : Resident ID No., Issue Date, Expiry Date. Resident ID No. which can be termed as National ID/ Personal No./ I.D. No./ Civil Number/ Civil ID No./ UID No. too. Issue Date which can be termed as Issuing Date/ Date of Issue too. Expiry Date which can be termed as Until Valid.If Resident ID is not having Issue date then  leave output as blank. Don't consider Date Of Birth as Issue date",
    },
    { role: "user", 
    content: `${data1}, ${data2}` },
